...
(() => {
  ...
  const nodes=Array.from(document.querySelectorAll('.work-heading,#about > .eyebrow,#about > div > h2,#about > div > p,#about .skills,#about .resume-block > h3,#about .experience-row,#about .tool-list > div,#about .education > h4,#about .education > p,#contact > .eyebrow,#contact > h2,#contact > p:not(.eyebrow),#contact > a,#contact .social-links,footer'));
